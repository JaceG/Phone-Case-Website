...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_phone_models_brand" AS ENUM('apple', 'samsung', 'google', 'other');
  CREATE TYPE "public"."enum_phone_models_status" AS ENUM('active', 'comingSoon', 'retired');
  CREATE TYPE "public"."enum_artwork_license" AS ENUM('original', 'commissioned', 'licensed', 'revenueShare');
  CREATE TYPE "public"."enum_artwork_color_profile" AS ENUM('sRGB', 'adobeRGB', 'cmyk');
  CREATE TYPE "public"."enum_production_assets_kind" AS ENUM('dieline', 'blend', 'shell', 'uvChecker', 'other');
  CREATE TYPE "public"."enum_case_blanks_references_kind" AS ENUM('blank', 'finishedCase', 'phone', 'sample');
  CREATE TYPE "public"."enum_case_blanks_priority" AS ENUM('normal', 'high');
  CREATE TYPE "public"."enum_case_blanks_build_stage" AS ENUM('queued', 'modeling', 'rendering', 'ready', 'failed');
  CREATE TYPE "public"."enum_case_blanks_availability" AS ENUM('unverified', 'verified', 'unavailable');
  CREATE TYPE "public"."enum_case_blanks_camera_coverage" AS ENUM('fineHoles', 'open', 'unknown');
  CREATE TYPE "public"."enum_case_blanks_preview_status" AS ENUM('draft', 'review', 'changes', 'approved', 'rejected');
  CREATE TYPE "public"."enum_case_blanks_sample_status" AS ENUM('pending', 'changes', 'validated');
  ...
  CREATE TYPE "public"."enum_products_render_status" AS ENUM('pending', 'rendering', 'ready', 'failed');
  ...
  CREATE TYPE "public"."enum__products_v_version_render_status" AS ENUM('pending', 'rendering', 'ready', 'failed');
  ...
  CREATE TYPE "public"."enum_orders_fulfillment_print_status" AS ENUM('queued', 'printing', 'printed', 'qc', 'packed', 'shipped', 'cancelled');
  ...
  CREATE TABLE "phone_models" (
  	...
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar NOT NULL,
  	"brand" "enum_phone_models_brand" DEFAULT 'apple' NOT NULL,
  	"screen_inches" numeric,
  	"release_year" numeric,
  	"status" "enum_phone_models_status" DEFAULT 'comingSoon' NOT NULL,
  	...
  	"camera_island_height_mm" numeric,
  	"geometry_notes" varchar,
  	"print_template_id" integer,
  	"shell_model_id" integer,
  	"blend_file_id" integer,
  	"blank_supplier_name" varchar,
  	"blank_supplier_sku" varchar,
  	"blank_supplier_url" varchar,
  	"blank_supplier_material" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "artwork" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"license" "enum_artwork_license" NOT NULL,
  	"designer" varchar,
  	"color_profile" "enum_artwork_color_profile" DEFAULT 'sRGB',
  	"dpi" numeric,
  ...
  CREATE TABLE "production_assets" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"kind" "enum_production_assets_kind" DEFAULT 'other' NOT NULL,
  	"notes" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"url" varchar,
  ...
  CREATE TABLE "studio_revisions" (
  	...
  	"print_master_id" integer NOT NULL,
  	"preview_id" integer,
  ...
  CREATE TABLE "case_blanks_references" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"url" varchar NOT NULL,
  	"kind" "enum_case_blanks_references_kind" NOT NULL,
  	"notes" varchar
  );
  
  CREATE TABLE "case_blanks_review_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "case_blanks" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"reference_key" varchar NOT NULL,
  	"phone_model_id" integer NOT NULL,
  	"batch" varchar,
  	"priority" "enum_case_blanks_priority" DEFAULT 'normal',
  	"build_stage" "enum_case_blanks_build_stage",
  	"build_error" varchar,
  	"review_feedback" varchar,
  	"review_history" jsonb,
  	"supplier_u_r_l" varchar,
  	"supplier_variant" varchar,
  	"availability" "enum_case_blanks_availability" DEFAULT 'unverified',
  	"availability_checked_at" timestamp(3) with time zone,
  	"camera_coverage" "enum_case_blanks_camera_coverage" DEFAULT 'unknown',
  	"preview_status" "enum_case_blanks_preview_status" DEFAULT 'draft' NOT NULL,
  	"sample_status" "enum_case_blanks_sample_status" DEFAULT 'pending' NOT NULL,
  	"geometry_version" varchar NOT NULL,
  ...
  CREATE TABLE "products_renders_turntable" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"frame_id" integer
  ...
  CREATE TABLE "products_renders_tumble" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"frame_id" integer
  ...
  CREATE TABLE "products_model_renders_turntable" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"frame_id" integer
  ...
  CREATE TABLE "products_model_renders_tumble" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"frame_id" integer
  ...
  CREATE TABLE "products_model_renders" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"phone_model_id" integer,
  	"hero_id" integer,
  	"three_quarter_id" integer,
  	"flat_id" integer,
  	"tumble_phases" jsonb
  );
  ...
  CREATE TABLE "products" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"catalog_defaults" jsonb,
  	"title" varchar,
  	"studio_presentation" jsonb,
  	"artwork_id" integer,
  	"tagline" varchar,
  	"description" jsonb,
  	"render_status" "enum_products_render_status" DEFAULT 'pending',
  	"renders_hero_id" integer,
  	"renders_three_quarter_id" integer,
  	"renders_flat_id" integer,
  	"renders_tumble_phases" jsonb,
  ...
  CREATE TABLE "_products_v_version_palette" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"hex" varchar,
  ...
  CREATE TABLE "_products_v_version_renders_turntable" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"frame_id" integer,
  ...
  CREATE TABLE "_products_v_version_renders_tumble" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"frame_id" integer,
  ...
  CREATE TABLE "_products_v_version_model_renders_turntable" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"frame_id" integer,
  ...
  CREATE TABLE "_products_v_version_model_renders_tumble" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"frame_id" integer,
  ...
  CREATE TABLE "_products_v_version_model_renders" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"phone_model_id" integer,
  ...
  CREATE TABLE "_products_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_catalog_defaults" jsonb,
  	"version_title" varchar,
  	"version_studio_presentation" jsonb,
  	"version_artwork_id" integer,
  	"version_tagline" varchar,
  	"version_description" jsonb,
  	"version_render_status" "enum__products_v_version_render_status" DEFAULT 'pending',
  	"version_renders_hero_id" integer,
  	"version_renders_three_quarter_id" integer,
  	"version_renders_flat_id" integer,
  	"version_renders_tumble_phases" jsonb,
  	"version_enable_variants" boolean DEFAULT true,
  	"version_price_in_u_s_d_enabled" boolean,
  	"version_price_in_u_s_d" numeric,
  	"version_meta_title" varchar,
  	"version_meta_image_id" integer,
  ...
  CREATE TABLE "orders_print_jobs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "orders" (
  	...
  	"fulfillment_print_status" "enum_orders_fulfillment_print_status" DEFAULT 'queued',
  	"fulfillment_printed_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"categories_id" integer,
  	"media_id" integer,
  	"phone_models_id" integer,
  	"artwork_id" integer,
  	"production_assets_id" integer,
  	"studio_revisions_id" integer,
  	"case_blanks_id" integer,
  	"forms_id" integer,
  ...
  ALTER TABLE "phone_models" ADD CONSTRAINT "phone_models_variant_option_id_variant_options_id_fk" FOREIGN KEY ("variant_option_id") REFERENCES "public"."variant_options"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "phone_models" ADD CONSTRAINT "phone_models_print_template_id_production_assets_id_fk" FOREIGN KEY ("print_template_id") REFERENCES "public"."production_assets"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "phone_models" ADD CONSTRAINT "phone_models_shell_model_id_production_assets_id_fk" FOREIGN KEY ("shell_model_id") REFERENCES "public"."production_assets"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "phone_models" ADD CONSTRAINT "phone_models_blend_file_id_production_assets_id_fk" FOREIGN KEY ("blend_file_id") REFERENCES "public"."production_assets"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "studio_revisions" ADD CONSTRAINT "studio_revisions_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "studio_revisions" ADD CONSTRAINT "studio_revisions_original_id_artwork_id_fk" FOREIGN KEY ("original_id") REFERENCES "public"."artwork"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "studio_revisions" ADD CONSTRAINT "studio_revisions_print_master_id_artwork_id_fk" FOREIGN KEY ("print_master_id") REFERENCES "public"."artwork"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "studio_revisions" ADD CONSTRAINT "studio_revisions_preview_id_production_assets_id_fk" FOREIGN KEY ("preview_id") REFERENCES "public"."production_assets"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "studio_revisions" ADD CONSTRAINT "studio_revisions_saved_by_id_users_id_fk" FOREIGN KEY ("saved_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "case_blanks_references" ADD CONSTRAINT "case_blanks_references_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."case_blanks"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "case_blanks_review_images" ADD CONSTRAINT "case_blanks_review_images_image_id_production_assets_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."production_assets"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "case_blanks_review_images" ADD CONSTRAINT "case_blanks_review_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."case_blanks"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "case_blanks" ADD CONSTRAINT "case_blanks_phone_model_id_phone_models_id_fk" FOREIGN KEY ("phone_model_id") REFERENCES "public"."phone_models"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "case_blanks" ADD CONSTRAINT "case_blanks_reviewed_by_id_users_id_fk" FOREIGN KEY ("reviewed_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "products_palette" ADD CONSTRAINT "products_palette_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products_renders_turntable" ADD CONSTRAINT "products_renders_turntable_frame_id_media_id_fk" FOREIGN KEY ("frame_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_renders_turntable" ADD CONSTRAINT "products_renders_turntable_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products_renders_tumble" ADD CONSTRAINT "products_renders_tumble_frame_id_media_id_fk" FOREIGN KEY ("frame_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_renders_tumble" ADD CONSTRAINT "products_renders_tumble_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products_model_renders_turntable" ADD CONSTRAINT "products_model_renders_turntable_frame_id_media_id_fk" FOREIGN KEY ("frame_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_model_renders_turntable" ADD CONSTRAINT "products_model_renders_turntable_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products_model_renders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products_model_renders_tumble" ADD CONSTRAINT "products_model_renders_tumble_frame_id_media_id_fk" FOREIGN KEY ("frame_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_model_renders_tumble" ADD CONSTRAINT "products_model_renders_tumble_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products_model_renders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products_model_renders" ADD CONSTRAINT "products_model_renders_phone_model_id_phone_models_id_fk" FOREIGN KEY ("phone_model_id") REFERENCES "public"."phone_models"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_model_renders" ADD CONSTRAINT "products_model_renders_hero_id_media_id_fk" FOREIGN KEY ("hero_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_model_renders" ADD CONSTRAINT "products_model_renders_three_quarter_id_media_id_fk" FOREIGN KEY ("three_quarter_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_model_renders" ADD CONSTRAINT "products_model_renders_flat_id_media_id_fk" FOREIGN KEY ("flat_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_model_renders" ADD CONSTRAINT "products_model_renders_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "products" ADD CONSTRAINT "products_artwork_id_artwork_id_fk" FOREIGN KEY ("artwork_id") REFERENCES "public"."artwork"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products" ADD CONSTRAINT "products_renders_hero_id_media_id_fk" FOREIGN KEY ("renders_hero_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products" ADD CONSTRAINT "products_renders_three_quarter_id_media_id_fk" FOREIGN KEY ("renders_three_quarter_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products" ADD CONSTRAINT "products_renders_flat_id_media_id_fk" FOREIGN KEY ("renders_flat_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_version_palette" ADD CONSTRAINT "_products_v_version_palette_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_products_v_version_renders_turntable" ADD CONSTRAINT "_products_v_version_renders_turntable_frame_id_media_id_fk" FOREIGN KEY ("frame_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_renders_turntable" ADD CONSTRAINT "_products_v_version_renders_turntable_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_products_v_version_renders_tumble" ADD CONSTRAINT "_products_v_version_renders_tumble_frame_id_media_id_fk" FOREIGN KEY ("frame_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_renders_tumble" ADD CONSTRAINT "_products_v_version_renders_tumble_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders_turntable" ADD CONSTRAINT "_products_v_version_model_renders_turntable_frame_id_media_id_fk" FOREIGN KEY ("frame_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders_turntable" ADD CONSTRAINT "_products_v_version_model_renders_turntable_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v_version_model_renders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders_tumble" ADD CONSTRAINT "_products_v_version_model_renders_tumble_frame_id_media_id_fk" FOREIGN KEY ("frame_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders_tumble" ADD CONSTRAINT "_products_v_version_model_renders_tumble_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v_version_model_renders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders" ADD CONSTRAINT "_products_v_version_model_renders_phone_model_id_phone_models_id_fk" FOREIGN KEY ("phone_model_id") REFERENCES "public"."phone_models"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders" ADD CONSTRAINT "_products_v_version_model_renders_hero_id_media_id_fk" FOREIGN KEY ("hero_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders" ADD CONSTRAINT "_products_v_version_model_renders_three_quarter_id_media_id_fk" FOREIGN KEY ("three_quarter_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders" ADD CONSTRAINT "_products_v_version_model_renders_flat_id_media_id_fk" FOREIGN KEY ("flat_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_model_renders" ADD CONSTRAINT "_products_v_version_model_renders_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v" ADD CONSTRAINT "_products_v_version_artwork_id_artwork_id_fk" FOREIGN KEY ("version_artwork_id") REFERENCES "public"."artwork"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v" ADD CONSTRAINT "_products_v_version_renders_hero_id_media_id_fk" FOREIGN KEY ("version_renders_hero_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v" ADD CONSTRAINT "_products_v_version_renders_three_quarter_id_media_id_fk" FOREIGN KEY ("version_renders_three_quarter_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v" ADD CONSTRAINT "_products_v_version_renders_flat_id_media_id_fk" FOREIGN KEY ("version_renders_flat_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "orders_print_jobs" ADD CONSTRAINT "orders_print_jobs_artwork_id_artwork_id_fk" FOREIGN KEY ("artwork_id") REFERENCES "public"."artwork"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders_print_jobs" ADD CONSTRAINT "orders_print_jobs_variant_id_variants_id_fk" FOREIGN KEY ("variant_id") REFERENCES "public"."variants"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders_print_jobs" ADD CONSTRAINT "orders_print_jobs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_phone_models_fk" FOREIGN KEY ("phone_models_id") REFERENCES "public"."phone_models"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_production_assets_fk" FOREIGN KEY ("production_assets_id") REFERENCES "public"."production_assets"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_studio_revisions_fk" FOREIGN KEY ("studio_revisions_id") REFERENCES "public"."studio_revisions"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_case_blanks_fk" FOREIGN KEY ("case_blanks_id") REFERENCES "public"."case_blanks"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "phone_models_slug_idx" ON "phone_models" USING btree ("slug");
  CREATE INDEX "phone_models_variant_option_idx" ON "phone_models" USING btree ("variant_option_id");
  CREATE INDEX "phone_models_print_template_idx" ON "phone_models" USING btree ("print_template_id");
  CREATE INDEX "phone_models_shell_model_idx" ON "phone_models" USING btree ("shell_model_id");
  CREATE INDEX "phone_models_blend_file_idx" ON "phone_models" USING btree ("blend_file_id");
  CREATE INDEX "phone_models_updated_at_idx" ON "phone_models" USING btree ("updated_at");
  CREATE INDEX "phone_models_created_at_idx" ON "phone_models" USING btree ("created_at");
  ...
  CREATE UNIQUE INDEX "artwork_filename_idx" ON "artwork" USING btree ("filename");
  CREATE INDEX "production_assets_updated_at_idx" ON "production_assets" USING btree ("updated_at");
  CREATE INDEX "production_assets_created_at_idx" ON "production_assets" USING btree ("created_at");
  CREATE UNIQUE INDEX "production_assets_filename_idx" ON "production_assets" USING btree ("filename");
  CREATE INDEX "studio_revisions_lineage_idx" ON "studio_revisions" USING btree ("lineage");
  CREATE UNIQUE INDEX "studio_revisions_version_key_idx" ON "studio_revisions" USING btree ("version_key");
  CREATE INDEX "studio_revisions_product_idx" ON "studio_revisions" USING btree ("product_id");
  CREATE INDEX "studio_revisions_original_idx" ON "studio_revisions" USING btree ("original_id");
  CREATE INDEX "studio_revisions_print_master_idx" ON "studio_revisions" USING btree ("print_master_id");
  CREATE INDEX "studio_revisions_preview_idx" ON "studio_revisions" USING btree ("preview_id");
  CREATE INDEX "studio_revisions_saved_by_idx" ON "studio_revisions" USING btree ("saved_by_id");
  CREATE INDEX "studio_revisions_updated_at_idx" ON "studio_revisions" USING btree ("updated_at");
  CREATE INDEX "studio_revisions_created_at_idx" ON "studio_revisions" USING btree ("created_at");
  CREATE INDEX "case_blanks_references_order_idx" ON "case_blanks_references" USING btree ("_order");
  CREATE INDEX "case_blanks_references_parent_id_idx" ON "case_blanks_references" USING btree ("_parent_id");
  CREATE INDEX "case_blanks_review_images_order_idx" ON "case_blanks_review_images" USING btree ("_order");
  CREATE INDEX "case_blanks_review_images_parent_id_idx" ON "case_blanks_review_images" USING btree ("_parent_id");
  CREATE INDEX "case_blanks_review_images_image_idx" ON "case_blanks_review_images" USING btree ("image_id");
  CREATE UNIQUE INDEX "case_blanks_reference_key_idx" ON "case_blanks" USING btree ("reference_key");
  CREATE INDEX "case_blanks_phone_model_idx" ON "case_blanks" USING btree ("phone_model_id");
  CREATE INDEX "case_blanks_batch_idx" ON "case_blanks" USING btree ("batch");
  CREATE INDEX "case_blanks_reviewed_by_idx" ON "case_blanks" USING btree ("reviewed_by_id");
  CREATE INDEX "case_blanks_updated_at_idx" ON "case_blanks" USING btree ("updated_at");
  CREATE INDEX "case_blanks_created_at_idx" ON "case_blanks" USING btree ("created_at");
  ...
  CREATE INDEX "products_palette_order_idx" ON "products_palette" USING btree ("_order");
  CREATE INDEX "products_palette_parent_id_idx" ON "products_palette" USING btree ("_parent_id");
  CREATE INDEX "products_renders_turntable_order_idx" ON "products_renders_turntable" USING btree ("_order");
  CREATE INDEX "products_renders_turntable_parent_id_idx" ON "products_renders_turntable" USING btree ("_parent_id");
  CREATE INDEX "products_renders_turntable_frame_idx" ON "products_renders_turntable" USING btree ("frame_id");
  CREATE INDEX "products_renders_tumble_order_idx" ON "products_renders_tumble" USING btree ("_order");
  CREATE INDEX "products_renders_tumble_parent_id_idx" ON "products_renders_tumble" USING btree ("_parent_id");
  CREATE INDEX "products_renders_tumble_frame_idx" ON "products_renders_tumble" USING btree ("frame_id");
  CREATE INDEX "products_model_renders_turntable_order_idx" ON "products_model_renders_turntable" USING btree ("_order");
  CREATE INDEX "products_model_renders_turntable_parent_id_idx" ON "products_model_renders_turntable" USING btree ("_parent_id");
  CREATE INDEX "products_model_renders_turntable_frame_idx" ON "products_model_renders_turntable" USING btree ("frame_id");
  CREATE INDEX "products_model_renders_tumble_order_idx" ON "products_model_renders_tumble" USING btree ("_order");
  CREATE INDEX "products_model_renders_tumble_parent_id_idx" ON "products_model_renders_tumble" USING btree ("_parent_id");
  CREATE INDEX "products_model_renders_tumble_frame_idx" ON "products_model_renders_tumble" USING btree ("frame_id");
  CREATE INDEX "products_model_renders_order_idx" ON "products_model_renders" USING btree ("_order");
  CREATE INDEX "products_model_renders_parent_id_idx" ON "products_model_renders" USING btree ("_parent_id");
  CREATE INDEX "products_model_renders_phone_model_idx" ON "products_model_renders" USING btree ("phone_model_id");
  CREATE INDEX "products_model_renders_hero_idx" ON "products_model_renders" USING btree ("hero_id");
  CREATE INDEX "products_model_renders_three_quarter_idx" ON "products_model_renders" USING btree ("three_quarter_id");
  CREATE INDEX "products_model_renders_flat_idx" ON "products_model_renders" USING btree ("flat_id");
  ...
  CREATE INDEX "products_artwork_idx" ON "products" USING btree ("artwork_id");
  CREATE INDEX "products_renders_renders_hero_idx" ON "products" USING btree ("renders_hero_id");
  CREATE INDEX "products_renders_renders_three_quarter_idx" ON "products" USING btree ("renders_three_quarter_id");
  CREATE INDEX "products_renders_renders_flat_idx" ON "products" USING btree ("renders_flat_id");
  ...
  CREATE INDEX "_products_v_version_palette_order_idx" ON "_products_v_version_palette" USING btree ("_order");
  CREATE INDEX "_products_v_version_palette_parent_id_idx" ON "_products_v_version_palette" USING btree ("_parent_id");
  CREATE INDEX "_products_v_version_renders_turntable_order_idx" ON "_products_v_version_renders_turntable" USING btree ("_order");
  CREATE INDEX "_products_v_version_renders_turntable_parent_id_idx" ON "_products_v_version_renders_turntable" USING btree ("_parent_id");
  CREATE INDEX "_products_v_version_renders_turntable_frame_idx" ON "_products_v_version_renders_turntable" USING btree ("frame_id");
  CREATE INDEX "_products_v_version_renders_tumble_order_idx" ON "_products_v_version_renders_tumble" USING btree ("_order");
  CREATE INDEX "_products_v_version_renders_tumble_parent_id_idx" ON "_products_v_version_renders_tumble" USING btree ("_parent_id");
  CREATE INDEX "_products_v_version_renders_tumble_frame_idx" ON "_products_v_version_renders_tumble" USING btree ("frame_id");
  CREATE INDEX "_products_v_version_model_renders_turntable_order_idx" ON "_products_v_version_model_renders_turntable" USING btree ("_order");
  CREATE INDEX "_products_v_version_model_renders_turntable_parent_id_idx" ON "_products_v_version_model_renders_turntable" USING btree ("_parent_id");
  CREATE INDEX "_products_v_version_model_renders_turntable_frame_idx" ON "_products_v_version_model_renders_turntable" USING btree ("frame_id");
  CREATE INDEX "_products_v_version_model_renders_tumble_order_idx" ON "_products_v_version_model_renders_tumble" USING btree ("_order");
  CREATE INDEX "_products_v_version_model_renders_tumble_parent_id_idx" ON "_products_v_version_model_renders_tumble" USING btree ("_parent_id");
  CREATE INDEX "_products_v_version_model_renders_tumble_frame_idx" ON "_products_v_version_model_renders_tumble" USING btree ("frame_id");
  CREATE INDEX "_products_v_version_model_renders_order_idx" ON "_products_v_version_model_renders" USING btree ("_order");
  CREATE INDEX "_products_v_version_model_renders_parent_id_idx" ON "_products_v_version_model_renders" USING btree ("_parent_id");
  CREATE INDEX "_products_v_version_model_renders_phone_model_idx" ON "_products_v_version_model_renders" USING btree ("phone_model_id");
  CREATE INDEX "_products_v_version_model_renders_hero_idx" ON "_products_v_version_model_renders" USING btree ("hero_id");
  CREATE INDEX "_products_v_version_model_renders_three_quarter_idx" ON "_products_v_version_model_renders" USING btree ("three_quarter_id");
  CREATE INDEX "_products_v_version_model_renders_flat_idx" ON "_products_v_version_model_renders" USING btree ("flat_id");
  ...
  CREATE INDEX "_products_v_version_version_artwork_idx" ON "_products_v" USING btree ("version_artwork_id");
  CREATE INDEX "_products_v_version_renders_version_renders_hero_idx" ON "_products_v" USING btree ("version_renders_hero_id");
  CREATE INDEX "_products_v_version_renders_version_renders_three_quarte_idx" ON "_products_v" USING btree ("version_renders_three_quarter_id");
  CREATE INDEX "_products_v_version_renders_version_renders_flat_idx" ON "_products_v" USING btree ("version_renders_flat_id");
  ...
  CREATE INDEX "orders_print_jobs_order_idx" ON "orders_print_jobs" USING btree ("_order");
  CREATE INDEX "orders_print_jobs_parent_id_idx" ON "orders_print_jobs" USING btree ("_parent_id");
  CREATE INDEX "orders_print_jobs_artwork_idx" ON "orders_print_jobs" USING btree ("artwork_id");
  CREATE INDEX "orders_print_jobs_variant_idx" ON "orders_print_jobs" USING btree ("variant_id");
  CREATE INDEX "orders_customer_idx" ON "orders" USING btree ("customer_id");
  CREATE INDEX "orders_fulfillment_fulfillment_print_status_idx" ON "orders" USING btree ("fulfillment_print_status");
  ...
  CREATE INDEX "payload_locked_documents_rels_phone_models_id_idx" ON "payload_locked_documents_rels" USING btree ("phone_models_id");
  CREATE INDEX "payload_locked_documents_rels_artwork_id_idx" ON "payload_locked_documents_rels" USING btree ("artwork_id");
  CREATE INDEX "payload_locked_documents_rels_production_assets_id_idx" ON "payload_locked_documents_rels" USING btree ("production_assets_id");
  CREATE INDEX "payload_locked_documents_rels_studio_revisions_id_idx" ON "payload_locked_documents_rels" USING btree ("studio_revisions_id");
  CREATE INDEX "payload_locked_documents_rels_case_blanks_id_idx" ON "payload_locked_documents_rels" USING btree ("case_blanks_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "phone_models" CASCADE;
  DROP TABLE "artwork" CASCADE;
  DROP TABLE "production_assets" CASCADE;
  DROP TABLE "studio_revisions" CASCADE;
  DROP TABLE "case_blanks_references" CASCADE;
  DROP TABLE "case_blanks_review_images" CASCADE;
  DROP TABLE "case_blanks" CASCADE;
  ...
  DROP TABLE "products_palette" CASCADE;
  DROP TABLE "products_renders_turntable" CASCADE;
  DROP TABLE "products_renders_tumble" CASCADE;
  DROP TABLE "products_model_renders_turntable" CASCADE;
  DROP TABLE "products_model_renders_tumble" CASCADE;
  DROP TABLE "products_model_renders" CASCADE;
  ...
  DROP TABLE "_products_v_version_palette" CASCADE;
  DROP TABLE "_products_v_version_renders_turntable" CASCADE;
  DROP TABLE "_products_v_version_renders_tumble" CASCADE;
  DROP TABLE "_products_v_version_model_renders_turntable" CASCADE;
  DROP TABLE "_products_v_version_model_renders_tumble" CASCADE;
  DROP TABLE "_products_v_version_model_renders" CASCADE;
  ...
  DROP TABLE "orders_print_jobs" CASCADE;
  ...
  DROP TYPE "public"."enum_phone_models_brand";
  DROP TYPE "public"."enum_phone_models_status";
  DROP TYPE "public"."enum_artwork_license";
  DROP TYPE "public"."enum_artwork_color_profile";
  DROP TYPE "public"."enum_production_assets_kind";
  DROP TYPE "public"."enum_case_blanks_references_kind";
  DROP TYPE "public"."enum_case_blanks_priority";
  DROP TYPE "public"."enum_case_blanks_build_stage";
  DROP TYPE "public"."enum_case_blanks_availability";
  DROP TYPE "public"."enum_case_blanks_camera_coverage";
  DROP TYPE "public"."enum_case_blanks_preview_status";
  DROP TYPE "public"."enum_case_blanks_sample_status";
  ...
  DROP TYPE "public"."enum_products_render_status";
  ...
  DROP TYPE "public"."enum__products_v_version_render_status";
  DROP TYPE "public"."enum__products_v_version_status";
  DROP TYPE "public"."enum_carts_currency";
  DROP TYPE "public"."enum_orders_status";
  DROP TYPE "public"."enum_orders_currency";
  DROP TYPE "public"."enum_orders_fulfillment_print_status";
